...
**Status (21 May 2026).** All five vocabulary-affecting open items resolved with Tobias Kuhn. FAIR² citation policy committed (SPS v1.2). GISAID accession populated for Alpha; Epsilon and Eta pending GISAID query. Awaiting Stage 1–3 minting session (`nanopub-skill` cloned to `~/nanopub-work/`).
...
| `data/` | `FDT4Claude_small_v1_1.csv`, `af_wuhan_1step_v1.csv`, `esm_wuhan_1step_v1.csv` | Source data: three-variant working CSV (v1.1, with GISAID accessions where known) plus full FAIR² ESM/AlphaFold datasets. |
